...
# be-admin Debt Collection (National Inkasso) — required at boot by DebtCollectionModule.
# The be-admin dynamo migrations runner self-creates the table in LocalStack; vendor SOAP disabled locally.
export DEBT_COLLECTION_TABLE_NAME="${DEBT_COLLECTION_TABLE_NAME:-calytics-be-admin-local-debt-collection-cases}"
export DEBT_COLLECTION_NATIONAL_INKASSO_ENABLED="${DEBT_COLLECTION_NATIONAL_INKASSO_ENABLED:-false}"
